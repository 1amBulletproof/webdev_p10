...
/**
 * Rates is an object that provides a cost for a booked tour. There is a base
 * rate and a premium rate that are used to calculate the cost of the tour.
 * Weekdays use the base rate, weekends use the premium rate.
 *
 * The premium rate is automatically generated as 1.5x the base rate
 *
 * @author evansrb1, brandon tarney
 */
public class Rates {

    public static enum HIKE {
        GARDINER(0), HELLROARING(1), BEATEN(2);
        private final int value;

        private HIKE(int value) {
            this.value = value;
        }
    ...
    /**
     * Status of validation of data. This is filled in once isValidDates() is
     * called
     *
    ...
    /**
     * Set the duration of the reservation. One day hikes means no overnight, a
     * two day hike is two days, one night.
     *
